...
<div class="content">
  <div class="row">
    <div class="col-md-5">
      <table id="tabelChart4b" class="table table-sm table-bordered table-hover" style="cursor:pointer; width:100%"></table>  
    </div>
    <div class="col-md-7">
      <div id="chart4b" style="display: block; width: 100%; height: 100%; padding: 0px 20px"></div>
    </div>
  </div>
</div>
<script>
  var chart4b; 
  function load_data4b() {
      if ($.fn.DataTable.isDataTable('#tabelChart4b')) {
          $('#tabelChart4b').DataTable().destroy();
      }
      ...
      $.ajax({
          ...
          success: function(response) {
              ...
              if (!chart4b) {
                  ...
                  chart4b = new ApexCharts(document.querySelector("#chart4b"), options);
                  chart4b.render();
              } else {
                  // Update chart data if it exists
                  chart4b.updateOptions({
                      series: jumlah,
                      labels: labels
                  });
              }
              ...
              $('#tabelChart4b_filter').css({'float':'right','display':'inline-block; background-color:black'});
          },
