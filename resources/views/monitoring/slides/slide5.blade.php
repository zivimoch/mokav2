...
<div class="heading">
    JUMLAH KORBAN PER BULAN YANG DITANGANI PPPA TAHUN 2024
    <br>
...
function load_data5() {
        // show load 
        $.ajax({
            url:'{{ route("api.v1.jumlahkorban") }}?pengelompokan=bulan&basis_tanggal=tanggal_approve&tanggal=2024-01-01%20-%202024-05-04&basis_wilayah=default&wilayah=default&penghitungan_usia=lapor&regis=1&arsip=0',
            type:'GET',
            dataType: 'json',
