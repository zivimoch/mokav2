...
<div class="content">
  <div class="row">
    <div class="col-md-5">
      <table id="tabelChart4c" class="table table-sm table-bordered table-hover" style="cursor:pointer; width:100%"></table>  
    </div>
    <div class="col-md-7">
      <div id="chart4c" style="display: block; width: 100%; height: 100%; padding: 0px 20px"></div>
    </div>
  </div>
</div>
<script>
  var chart4c; 
  function load_data4c() {
      if ($.fn.DataTable.isDataTable('#tabelChart4c')) {
          $('#tabelChart4c').DataTable().destroy();
      }

      pengelompokan = 'tahun';
      basisTanggal = 'tanggal_approve';
      tanggal = '2024-01-01 - 2024-05-07';
      basisWilayah = 'domisili';
      regis = 1;
      arsip = 0;
      ...
      $.ajax({
          ...
          success: function(response) {
              ...
              if (!chart4c) {
                  ...
                  chart4c = new ApexCharts(document.querySelector("#chart4c"), options);
                  chart4c.render();
              } else {
                  // Update chart data if it exists
                  chart4c.updateOptions({
                      series: jumlah,
                      labels: labels
                  });
              }
              ...
              $('#tabelChart4c_filter').css({'float':'right','display':'inline-block; background-color:black'});
          },
