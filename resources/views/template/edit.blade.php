  ...
  <div class="col-md-12">
    ...
    <div class="card">
      <div class="card-header">
        <h3 class="card-title">Edit Template Dokumen > <span class='titleFormOutput' id='titleFormOutput'></span></h3>
      ...
      <!-- /.card-header -->
      <!-- form start -->
      <form method="POST" action="{{ route('template.update', $data->uuid) }}" role="form" id="wzform">
          ...
          <fieldset>
            <div class="form-card">
              <div class="form-group">
                ...
                <input type="text" name="nama_template" class="form-control" id="titleForm" value="{{ $data->nama_template }}">
              </div>
            </div>
            <div class="form-card">
              ...
              <select name="pemilik" class="form-control select2bs4" id="pemilik" style="width:100%" required>
                  ...
                  @foreach ($jabatan as $item)
                      <option value="{{ $item }}" {{ $data->pemilik == $item? 'selected':'' }}>{{ $item }}</option>
                  @endforeach
              </select>
            </div>
            <br>
            <div class="form-card">
              <div class="form-group">
                ...
                <select name="keyword[]" value="{{ $data_keyword }}" class="form-control select-tag" id="keyword" style="width:100%" multiple="multiple" required>
                  @if (count($data_keyword) > 0)
                      @foreach ($data_keyword as $item)
