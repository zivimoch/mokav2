              ...
              <div class="row"> 
                <div class="col-md-6"> 
                  ...
                  <div class="col-md-6"> 
                      <div class="form-group"> 
                          <label>Nama Lengkap <span style="color:red">*</span></label> 
                          <input name="nama_klien[]" id="nama_klien_klien1" type="text" class="form-control titlecase nama_klien" onkeyup="ubahtabtitle('klien1')" onchange="load_list_korban()" data-klien-id="1" required /> 
                      </div> 
                  </div> 
              </div> 
              <div class="row"> 
            ...
            <div class="row"> 
              ...
              <div class="row"> 
                ...
                <div class="row">   
                  ...
                  <div class="col-md-6">
                      <div class="form-group"> 
                          <label>Tindak Lanjut <span style="color:red">*</span></label> 
                          <select name="tindak_lanjut[0][]" id="layanan_kedaruratan_klien1" class="form-control select2bs4" style="width:100%" multiple="multiple" required> 
            ...
            <div id="terlapor1" class="tab-pane fade show active">
              <div class="row"> 
                <div class="col-md-6"> 
                  ...
                  <div class="col-md-6"> 
                      <div class="form-group"> 
                          <label>Nama Lengkap <span style="color:red">*</span></label> 
                          <input name="nama_terlapor[]" id="nama_terlapor_terlapor1" type="text" class="form-control titlecase" onkeyup="ubahtabtitle2('terlapor1');" data-terlapor-id="1" required /> 
                      </div> 
                  </div> 
              </div> 
              <div class="row"> 
              ...
              <div style="border: 1px dashed; padding:10px 10px 5px 10px; margin-bottom:15px">
                ...
                <div class="form-group"> 
                  <div class="row"> 
                    <div class="col-md-12">
                      <button class="btn btn-block btn-outline-secondary" type="button" onclick="load_list_korban(1)">Refresh List Korban</button> 
                      <br>
                    </div>
                    <div class="col-md-12">
                      <div class="list_korban list_korban_1"></div>
                    </div>
                  </div>
                </div>
              </div>
...
$(document).ready(function () {
  ...
  function getkotkab(field_id='') {
    ...
    function load_list_korban(ids = '') {
      let listHtml = '';
        $('.nama_klien').each(function (index) {
            let nama_klien = $(this).val();
            listHtml +=  '<tr><td>'+ (index + 1) +  '. Hubungan dengan <b>'+ nama_klien +'  (Terlapor siapanya Klien?)</b> </td><td> : </td><td> <select name="hubungan[]" class="form-control select2bs4" required><option value="" selected></option> @foreach ($hubungan_dengan_klien as $item) <option value="{{ $item }}" >{{ $item }}</option> @endforeach</select> </td></tr>';
        });

        if (ids !== undefined && ids !== null && ids !== '') {
            $('.list_korban_' + ids).html(listHtml);
        } else {
