    ...
    <form id="FormulirPelaporan" action="{{ route('formpenerimapengaduan.store') }}" method="POST">
      @csrf
        <fieldset>
            ...
            <input name="nama_pelapor" type="text" class="form-control titlecase" required value=""/>
            </div>
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
        ...
        <fieldset>
          ...
          <div class="tab-content tab-content-terlapor" style="padding-top: 20px">
            ...
            <div id="terlapor1" class="tab-pane fade show active">
              <div class="form-group">
                <label>Nama Lengkap</label>
                <input name="nama_terlapor[]" type="text" class="form-control titlecase" id="nama_terlapor_terlapor1" required value="" onkeyup="ubahtabtitle2('terlapor1')"/>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                        <label>Tempat Lahir</label>
                        <input name="tempat_lahir_terlapor[]" type="text" class="form-control titlecase" required value="dasdsa"/>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                        <label>Tanggal Lahir</label>
                        <input name="tanggal_lahir_terlapor[]" type="date" class="form-control" required value="2020-01-01"/>
                        </div>
                    </div>
                    <div class="col-md-4"> 
                      <div class="form-group"> <label>Jenis Kelamin</label> 
                        <select name="jenis_kelamin_terlapor[]" id="jenis_kelamin_terlapor1" class="form-control select2bs4" style="width:100%"> 
                ...
                <div class="form-group">
                  <div class="row">
                      <div class="col-md-3">
                          <label>Provinsi Domisili</label>
                          <select name="provinsi_id_terlapor[]" class="form-control select2bs4" id="provinsi_id_terlapor" style="width:100%" onchange="getkotkab('terlapor')" required>
                              <option value="" selected></option>
                              @foreach ($provinsi as $item)
                                  <option value="{{ $item->code }}" >{{ $item->name }}</option>
                              @endforeach
                      ...
                      <div class="col-md-3">
                          <div class="form-group">
                              <label>Kota Domisili</label>
                              <select name="kota_id_terlapor[]" class="form-control select2bs4" id="kota_id_terlapor" style="width: 100%" onchange="getkecamatan('terlapor')" required>
                                  <option value="" selected></option>
                              </select>
                          </div>
                      </div>
                      <div class="col-md-3">
                          <div class="form-group">
                              <label>Kecamatan Domisili</label>
                              <select name="kecamatan_id_terlapor[]" class="form-control select2bs4" id="kecamatan_id_terlapor" style="width: 100%">
                                  <option value="" selected></option>
                              </select>
                          </div>
                      </div>
                      <div class="col-md-3">
                          <div class="form-group">
                              <label>Kelurahan Domisili</label>
                              <input name="kelurahan_terlapor[]" type="text" class="form-control titlecase" required value=""/>
                          </div>
                      </div>
                      </div>
                  </div>
                    <div class="form-group">
                    <label>Alamat Domisili</label>
                    <textarea class="form-control" name="alamat_terlapor[]" required></textarea>
                    </div>
                    <div class="form-group">
                        <label>No Telp</label>
                        <input name="no_telp_terlapor[]" type="number" class="form-control" required value="089" />
                    </div>
            </div>
