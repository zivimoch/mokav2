          ...
          <div class="tab-content tab-content-terlapor" style="padding-top: 20px">
            ...
            <div class="form-group"> 
                <div class="row"> 
                    <div class="col-md-3"> 
                        <label>Provinsi Domisili</label> 
                        <select name="provinsi_id_terlapor[]" id="provinsi_id_terlapor_terlapor1" class="form-control select2bs4" onchange="getkotkab('terlapor_terlapor1')" style="width:100%" required> 
                            <option value="" selected></option> 
                            @foreach ($provinsi as $item) 
                            <option value="{{ $item->code }}" >{{ $item->name }}</option> 
                            @endforeach 
                    ...
                    <div class="col-md-3"> 
                        <div class="form-group"> 
                            <label>Kota Domisili</label> 
                            <select name="kota_id_terlapor[]" id="kota_id_terlapor_terlapor1" class="form-control select2bs4" style="width:100%" onchange="getkecamatan('terlapor_terlapor1')" required> 
                                <option value="" selected></option> 
                            </select> 
                        </div> 
                    </div> 
                    <div class="col-md-3"> 
                        <div class="form-group"> 
                            <label>Kecamatan Domisili</label> 
                            <select name="kecamatan_id_terlapor[]" id="kecamatan_id_terlapor_terlapor1" class="form-control select2bs4" style="width:100%" required> <option value="" selected>
                                </option> </select> 
                            </div> 
                        </div> 
                        <div class="col-md-3"> 
                            <div class="form-group"> 
                                <label>Kelurahan Domisili</label> 
                                <input type="text" name="kelurahan_terlapor[]" class="form-control titlecase" required> 
                            </div> 
                        </div> 
                    </div> 
                </div> 
                ...
                <div class="form-group"> 
                    ...
                    <div class="col-md-6"> 
                        <div class="form-group"> 
                            ...
                            <select name="status_pendidikan_terlapor[]" id="status_pendidikan_terlapor_terlapor1" class="form-control select2bs4" style="width:100%" required> 
                                <option value=""></option> 
                    ...
                    <div class="col-md-6"> 
                        <div class="form-group"> 
                            ...
                            <select name="pendidikan_terlapor[]" id="pendidikan_terlapor_terlapor1" class="form-control select2bs4" style="width:100%" required> 
                                <option value="" selected></option>
                    ...
                    <div class="form-group"> 
                        ...
                        <select name="hubungan_terlapor[]" id="hubungan_klien_terlapor1" class="form-control select2bs4" style="width:100%" required> 
                                <option value="" selected></option> 
