          ...
          <div class="tab-content tab-content-terlapor" style="padding-top: 20px">
            ...
            <div class="form-group"> 
                ...
                <div class="form-group"> 
                    ...
                    <div class="form-group"> 
                      <label>Hubungan Dengan Klien (Terlapor siapanya Klien?) <span style="color:red">*</span></label> 
                      <select name="hubungan_terlapor[]" class="form-control select2bs4" id="hubungan_klien_terlapor1" style="width:100%" required> 
                              <option value="" selected></option> 
                              @foreach ($hubungan_dengan_klien as $item) 
                              <option value="{{ $item }}" >{{ $item }}</option> 
                              @endforeach  
