    ...
    public function run()
    {
        ...
        $kasus = [
            [
                ...
                "no_reg" => NULL,
                "tanggal_pelaporan" => Carbon::now()->subDays(150),
                "tanggal_kejadian" => Carbon::now()->subDays(180),
                "tempat_kejadian" => 'Rumah Tinggal',
                "media_pengaduan" => 'Datang Langsung',
                "sumber_rujukan" => 'RS Cipto Mangunkusu',
                "sumber_informasi" => 'RS Cipto Mangunkusu',
                "deskripsi" => 'Klien mengalami kasus KDRT Penelantaran yang dilakukan oleh terlapor (suami). Klien dan terlapor sudah menikah secara resmi dan dikaruniai 2 anak. Klien di kunci bersama kedua anaknya yang berusia 4 tahun dan 2 bulan. Klien dan anaknya tidak memakai pakaian layak diluar rumah. Klien juga mengalami KDRT berupa dilempar benda oleh terlapor dan diseret keluar gerbang.',
                "provinsi_id" => 31,
                "kotkab_id" => 3175,
                "kecamatan_id" => 317506,
            ...
            [
                ...
                "sumber_rujukan" => 'KPAI',
                "sumber_informasi" => 'KPAI',
                "deskripsi" => 'Ibu klien ZeeBoy Millenix (ZM, 1 tahun) bernama Sidney Queensland Millenix (SQ, 30 tahun) menikah sirih dengan Terlapor Putin Millenix (PM, 30 tahun) pada tahun 2022 dengan kondisi Ibu klien sedang mengandung ZM. Setelah menikah SQ dan PM tinggal di Kemayoran. SQ dan PM berpisah ketika anak usia 6 bulan di tahun 2022 Sebelum menikah dengan PM, SQ telah mengetahui PM adalah orang yang keras. Ketika usia kandungan 7 bulan PM berselingkuh dengan Charli XCX (CX, 24 tahun). PM sering marah-marah kepada SQ. Aktifitas SQ bekerja sebagai buruh di pembuatan Roti Pada taggal 13 PM diberikan ijin untuk mengajak ZM satu Hari menginap dirumahnya, namun pada keesok harinya PM tidak mengembalikannya dengan alasan mau di ajak makan karena ibu PM sedang ulang tahun. Keesokan harinya ayah SQ mendatangi rumah PM dengan bermaksud membawa ZM pulang ke rumahnya karena pada saat itu SQ tidak dapat menemaninya karena sedang bekerja. Namun orang tua PM tidak mau meberikannya dan menyuruhnya untuk menandatangani surat yang menyatakan mengijinkan ZM tinggal satu minggu di rumah PM dengan memberikan keterangan nanti akan disaksikan oleh RT, RW dan Babinkantibmas. Selain itu PM juga menyuruh SQ untuk menandatangani surat tersebut, namun SQ dan ayahnya tidak mau menandatangani surat tersebut. Sampai saat ini ZM masih di rumah PM',
                "provinsi_id" => 31,
                "kotkab_id" => 3171,
                "kecamatan_id" => 317103,
                "kelurahan" => 'Harapan Mulya',
                "alamat" => 'Cempaka Wangi 3 RT 15 RW 09 No. 8 Harapan Mulia, Kemayoran, Kota Jakarta Pusat',
                "created_by" => NULL,
            ...
            ,[
                "uuid" => "3ae39e2b-f482-45f5-93d1-f50b20bc672a",
                "no_reg" => NULL,
                "tanggal_pelaporan" => Carbon::now()->subDays(60),
                "tanggal_kejadian" => Carbon::now()->subDays(90),
                "tempat_kejadian" => 'Rumah Tinggal',
                "media_pengaduan" => 'Datang Langsung',
                "sumber_rujukan" => 'KPAI',
                "sumber_informasi" => 'Komnas Perempuan',
                "deskripsi" => 'deskripsi',
                "provinsi_id" => 31,
                "kotkab_id" => 3173,
                "kecamatan_id" => 317302,
                ...
                "uuid" => "3ae37e2b-f482-45f5-93d1-f50b20bc672a",
                "no_reg" => NULL,
                "tanggal_pelaporan" => Carbon::now()->subDays(90),
                "tanggal_kejadian" => Carbon::now()->subDays(120),
                "tempat_kejadian" => 'Kos-kosan',
                "media_pengaduan" => 'Hotline',
                "sumber_rujukan" => NULL,
                "sumber_informasi" => 'KemenPPA',
                "deskripsi" => 'deskripsi',
                "provinsi_id" => 31,
                "kotkab_id" => 3174,
                "kecamatan_id" => 317404,
        ...
        $pelapor = [
            [
                "uuid" => "178e78db-f845-4abb-966b-4b727f3a1a2e",
                "kasus_id" => 1,
                "nik" => '3213029381729001',
                "nama" => 'Tumini Mikroorganisme',
            ...
            [
                "uuid" => "b568bf9f-44f0-42d6-9eab-db417a62b1ea",
                "kasus_id" => 2,
                "nik" => '13200292109',
                "nama" => 'Sidney Queensland Millenix',
            ...
            // DATA UNTUK UJI COBA GRAFIK, DAPAT DIDISABLED NANTI
            ,[
                "uuid" => "b668bf9f-44f0-42d6-9eab-db417a68b1ea",
                "kasus_id" => 3,
                "nik" => '3213031232918881',
                "nama" => 'Pelapor1',
                "tempat_lahir" => 'Bukit Tinggi',
                "tanggal_lahir" => '1993-02-12',
                "provinsi_id" => NULL,
                ...
                "no_telp" => NULL,
                "desil" => NULL,
                "hubungan_pelapor" => 'Ayah Tiri',
                "created_by" => 1,
                "created_at" => Carbon::now()->subDays(30),
                "updated_at" => Carbon::now(),
                "deleted_at" => NULL
            ],[
                "uuid" => "b628bf9f-44f0-42d6-9eab-db417a68b1ea",
                "kasus_id" => 3,
                "nik" => '3213031232918881',
                "nama" => 'Pelapor2',
                "tempat_lahir" => 'Bukit Tinggi',
        ...
        $klien = [
            [
                "uuid" => "456ab15f-1f30-48e1-a5c0-0e39c05a93ab",
                "kasus_id" => 1,
                "no_klien" => '001/'.date('m').'/'.date('Y'),
            ...
            [
                "uuid" => "cd0723c3-4505-466e-89bc-e1cc8e6e8b40",
                "kasus_id" => 1,
                "no_klien" => NULL,
                ...
                "suku" => 'Suku Betawi',
                "no_telp" => NULL,
                "status_pendidikan" => 'Belum Sekolah',
                ...
                "tanggal_lahir_ibu" => '1992-11-02',
                "nama_ayah" => 'Frankenstein Van Houten',
                "tempat_lahir_ayah" => 'Jakarta',
                "tanggal_lahir_ayah" => '1990-09-08',
                "hubungan_klien" => 'Anak Kandung',
                "no_lp" => NULL,
                "pengadilan_negri" => NULL,
                "isi_putusan" => NULL,
                "lpsk" => 0,
            ...
            [
                "uuid" => "9de132f6-1b55-4ca1-bcc0-4a3b1eeaf7cd",
                "kasus_id" => 2,
                "no_klien" => NULL,
                "status" => 'Pelengkapan Data',
                "nik" => NULL,
                "nama" => 'Zeeboy Millenix',
                "tempat_lahir" => 'Jakarta',
                ...
                "anak_ke" => 1,
                "jumlah_anak" => 4,
                "nama_ibu" => 'Sidney Queensland Millenix',
                "tempat_lahir_ibu" => 'Bukit Tinggi',
                "tanggal_lahir_ibu" => '1993-02-12',
                "nama_ayah" => NULL,
                "tempat_lahir_ayah" => NULL,
                "tanggal_lahir_ayah" => NULL,
                "hubungan_klien" => 'Anak Kandung',
            ...
            // DATA UNTUK UJI COBA GRAFIK, DAPAT DIDISABLED NANTI
            ,[
                "uuid" => "9de182f6-1b55-4ca1-bcc0-4a3b1eeaf7cd",
                "kasus_id" => 3,
                "no_klien" => NULL,
                "status" => 'Pelengkapan Data',
                "nik" => NULL,
                "nama" => 'Klien1',
                "tempat_lahir" => 'Tempat1',
                ...
                "uuid" => "9de182c6-1b55-4ca1-bcc0-4a3b1eeaf7cd",
                "kasus_id" => 4,
                "no_klien" => NULL,
                "status" => 'Pelengkapan Data',
                "nik" => NULL,
                ...
                "uuid" => "9dx182c6-1b55-4ca1-bcc0-4a3b1eeaf7cd",
                "kasus_id" => 4,
                "no_klien" => NULL,
                "status" => 'Pelengkapan Data',
                "nik" => NULL,
                ...
                "suku" => '',
                "no_telp" => NULL,
                "status_pendidikan" => 'Tidak Diketahui',
                "pendidikan" => 'TK',
                "kelas" => 1,
                "pekerjaan" => NULL,
                "penghasilan" => NULL,
                ...
                "uuid" => "9dx182c6-1b55-4ca2-bcc0-4a3b1eeaf7cd",
                "kasus_id" => 4,
                "no_klien" => NULL,
                "status" => 'Pelengkapan Data',
                "nik" => NULL,
        ...
        $terlapor = [
            [
                "uuid" => "10953a88-eadd-4c09-9098-3514f275355f",
                "kasus_id" => 1,
                "nik" => '132128119928',
                "nama" => 'Frankenstein Van Houten',
                "tempat_lahir" => 'Jakarta',
                ...
                "agama" => 'Islam',
                "suku" => 'Suku Betawi',
                "no_telp" => '082127662123',
                "status_pendidikan" => 'Lulus dan Tidak Melanjutkan (Tamat Belajar)',
                "pendidikan" => 'Perguruan Tinggi',
                "pekerjaan" => 'Swasta',
                "status_kawin" => 'Menikah Resmi',
                "jumlah_anak" => 1,
                "hubungan_terlapor" => 'Ayah Kandung',
                "desil" => NULL,
                "created_by" => 1,
                "created_at" => Carbon::now(),
                "updated_at" => Carbon::now(),
            ...
            [
                "uuid" => "f1829784-6175-42cb-8252-fe8cf266f492",
                "kasus_id" => 2,
                "nik" => NULL,
                "nama" => 'Putin Millenix',
                "tempat_lahir" => NULL,
            ...
            // DATA UNTUK UJI COBA GRAFIK, DAPAT DIDISABLED NANTI
            ,[
                "uuid" => "f1029784-6175-42cb-8252-fe8cf266f492",
                "kasus_id" => 3,
                "nik" => NULL,
                "nama" => 'Terlapor1',
                "tempat_lahir" => NULL,
